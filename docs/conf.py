# -*- coding: utf-8 -*-
#
# phyluce documentation build configuration file, created by
# sphinx-quickstart on Thu Mar  1 14:35:07 2012.
#
...
sys.path.insert(0, os.path.abspath('../phyluce'))
...
project = u"phyluce"
copyright = u"2012-2023, Brant C. Faircloth"
...
man_pages = [
    ("index", "phyluce", u"phyluce documentation", [u"Brant C. Faircloth"], 1)
]
